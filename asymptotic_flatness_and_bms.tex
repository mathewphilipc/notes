...
g_{AB} dx^A dx^B \equiv r^2 q_{AB} dx^A dx^B \implies \D_r \det (q_{AB}) = 0.
\end{equation}
...
g_{uA} & = \mc{O}(1), \\
g_{AB} & = r^2 q_{AB}^{\mbox{\tiny{MB}}} + \mc{O}(r).
\end{aligned}
\end{equation}
