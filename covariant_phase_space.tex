...
\end{aligned}
\end{equation}
It is in this sense that $\delta H_\xi$ interacts with the symplectic form to generate the changes in observables (concretely, scalars on phase space) induced by phase space diffeomorphisms. 
